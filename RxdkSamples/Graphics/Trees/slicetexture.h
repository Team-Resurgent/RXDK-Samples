...
// File: SliceTexture.h
//
// Desc: A set of textures generated by rendering with a tight set of
...
public:
    ...
    HRESULT GenerateSlices( DWORD width, DWORD height, DWORD dwNumSlices, 
    ...
    // Load slice textures from file
    HRESULT Load(UINT Width, UINT Height, UINT nSlice, CHAR *strName);

    // Save slice textures to file
    HRESULT Save(CHAR *strName);
};
