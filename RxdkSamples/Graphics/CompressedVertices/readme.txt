//-----------------------------------------------------------------------------
// Name: CompressedVertices Xbox Sample
// 
...
Description
===========
   The CompressedVertices sample demonstrates the bandwidth-saving technique of
...
=================
   ...
   Note that you can compress other vertex components besides normals. Things
   that range [-1..1] like texture coordinates and tangent space vectors are
   good candidates.
