...
struct PlayerInfo
{
    ...
    DWORD   bHasVoice:4;                      // Which ports have communicators
};
...
struct MsgVoiceInfo
{
    ...
    WCHAR       strSrcPlayer[ MAX_PLAYER_NAME ];    // Name of source player
    WORD        wControllerPort;    // XUID can be constructed from IN_ADDR and port
    WCHAR       strDestPlayer[ MAX_PLAYER_NAME ];    // Name of destination player
    WORD        wDestPort;          // Some operations are for a specific player
};
