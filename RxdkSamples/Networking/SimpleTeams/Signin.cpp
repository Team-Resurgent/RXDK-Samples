...
//-----------------------------------------------------------------------------
// RXDK: this sample's own Signin.cpp is absent from the 5849 XDK install; adapted from
// SimpleFriends' copy to the service-list signature SimpleTeams.cpp declares.
BOOL SignIn( XONLINE_USER *pLogonUsers, const DWORD *pdwServiceIDs, DWORD dwNumServices )
{
    ...
    HRESULT hr = XOnlineLogon( pLogonUsers, pdwServiceIDs, dwNumServices, NULL, &hLogonTask );
