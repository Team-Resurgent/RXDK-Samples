...
//       11.05.03 - Modified to not reboot
//
...
BOOL SignIn( XONLINE_USER *pLogonUsers, const DWORD *pdwServiceIDs, DWORD dwServices )
{
    ...
    HRESULT hr = XOnlineLogon( pLogonUsers, pdwServiceIDs, dwServices, NULL, &hLogonTask );
    ...
    case XONLINE_E_LOGON_NO_NETWORK_CONNECTION:
        ...
        Error( L"No network connection detected." );
#ifdef XBOX_SAMPLE
